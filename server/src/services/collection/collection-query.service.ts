    ...
    const nodes: CollectionNode[] = children.map((child) => {
      ...
      if (child.assetType === "color" && child.assetId && child.colorHex) {
        return {
          ...
          type: "color" as const,
          hex: child.colorHex,
          gradient: child.colorGradient ?? null,
          note: child.colorNote,
          title: child.title,
          isFavorite: child.isFavorite ?? false,
          createdAt: child.createdAt.toISOString(),
          updatedAt: child.assetUpdatedAt?.toISOString(),
        ...
        return projectLinkNode(
          {
            ...
            resolverKey: child.linkResolverKey ?? "generic-html",
            providerExtensions: child.linkProviderExtensions ?? {},
            ...
            assetCreatedAt: child.assetCreatedAt ?? child.createdAt,
            assetUpdatedAt: child.assetUpdatedAt,
          },
