...
function DrawerOverlay({
  ...
  className,
  ...props
}: DrawerPrimitive.Backdrop.Props & { fast?: boolean }) {
  return (
    <DrawerPrimitive.Backdrop
      ...
      className={cn(
        ...
        fast &&
          "duration-[200ms] data-ending-style:duration-[200ms] data-starting-style:duration-[200ms]",
        className,
      )}
      {...props}
    />
...
function DrawerContent({
  ...
  const { hasSnapPoints, modal, showSwipeHandle, fast, swipeDirection } =
    useDrawer();
  const swipeAxis =
      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Direction: down.
            "data-[swipe-direction=down]:bottom-0 data-[swipe-direction=down]:origin-bottom data-[swipe-direction=down]:[--closed-transform:translate3d(var(--translate-x,0px),calc(100%+var(--drawer-inset,0px)+2px),0)] data-[swipe-direction=down]:[--translate-y:calc(var(--drawer-snap-point-offset,0px)+var(--drawer-swipe-movement-y)-var(--stack-peek-offset)-(var(--stack-shrink)*var(--stack-height)))]",
            // Direction: up.
